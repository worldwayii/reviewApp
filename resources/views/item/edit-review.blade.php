	...
	<div class="row">
		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default" style="margin-top: 150px;">
				<div class="panel-heading" style="margin-bottom: 15px;">Edit Review </div>
				<div class="panel-body">
                        ...
                        @endif
					<form class="form-horizontal" method="POST" action="{{url('item/review/update')}}" enctype="multipart/form-data">
						{{ csrf_field() }}
						{{-- Checks if there is a user in section, id not show user_name form --}}
						@if(!Session()->has('user'))
						<div class="form-group {{ ($errors->has('user_name')) ? 'has-error' : ''}}">
							<label for="username" class="col-md-4 control-label">Your User Name</label>
							<div class="col-md-6">
